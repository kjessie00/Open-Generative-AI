...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { id: 'pipeline', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 6h16"/><path d="M4 12h10"/><path d="M4 18h16"/><circle cx="18" cy="12" r="2"/></svg>', label: 'Pipeline' },
