...
export const sampleMediaAttempts = Object.freeze([
    Object.freeze({
        media_id: 'character_operator_v1',
        kind: 'character_sheet',
        target_id: 'operator',
        provider: 'dst',
        operation_id: 'mock-dst-character-001',
        attempt: 1,
        reference_ids: [],
        path: sampleAssets[0].path,
        generation_status: 'fixture_only',
        review_status: 'accepted',
        retry_of: '',
        review_note: 'MOCK: 캐릭터 실루엣 기준 시트입니다.',
        selected_for_retry: false,
    }),
    Object.freeze({
        media_id: 'location_control_room_v1',
        kind: 'location_sheet',
        target_id: 'local_pipeline_dashboard',
        provider: 'dst',
        operation_id: 'mock-dst-location-001',
        attempt: 1,
        reference_ids: [],
        path: sampleAssets[0].path,
        generation_status: 'fixture_only',
    ...
    Object.freeze({
        media_id: 'clip_001_frame_v1',
        kind: 'scene_image',
        target_id: 'clip_001',
        provider: 'dst',
        operation_id: 'mock-dst-scene-001',
        attempt: 1,
        reference_ids: ['character_operator_v1', 'location_control_room_v1'],
        path: sampleAssets[0].path,
        generation_status: 'fixture_only',
        review_status: 'needs_changes',
        retry_of: '',
        review_note: 'MOCK: 화면 글자 표현을 단순화해야 합니다.',
        selected_for_retry: false,
    }),
    Object.freeze({
        media_id: 'clip_001_video_v1',
        kind: 'video',
        target_id: 'clip_001',
        provider: 'flow',
        operation_id: 'mock-flow-video-001',
        attempt: 1,
        reference_ids: ['clip_001_frame_v1'],
        path: '',
...
export const samplePipelineState = Object.freeze({
    ...
    assets: [...sampleAssets],
    mediaAttempts: [...sampleMediaAttempts],
