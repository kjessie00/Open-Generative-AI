...
- G3 인간 검토 작업대: Chromium `atob` receiver 수정 뒤 실제 Electron Blob preview, 초안 저장·내보내기, full quit/relaunch 복원과 별도 OS 창 캡처 PASS
...
2026-07-14 receiver 회귀를 포함한 blob preview focused 검증은 22/22, 전체
network-denied suite는 148/148, lint와 Vite build 48 modules가 PASS했습니다.
별도 실제 Electron 회차도 Blob-only preview, save/export와 full quit/relaunch를
PASS했습니다. 상세 결과는
...
후속 [`37_g3_blob_preview_runtime_fix.md`](docs/ui_integration/37_g3_blob_preview_runtime_fix.md)에 기록합니다.
