...
- 실제 Electron 창: 현재 21-method bridge, 11개 한글 메뉴, 4개 반응형 화면과 두 승인 production의 비-native 읽기 PASS
...
2026-07-14 G3 promotion focused 검증은 40/40, 전체 network-denied suite는
158/158, lint와 Vite build 50 modules가 PASS했습니다. 별도 실제 Electron 회차도
Blob-only preview/save/export 복원에 이어 fixture의 exact production 반영, 21-method
bridge, 이미 최신 no-op와 full quit/relaunch를 PASS했습니다. 상세 결과는
...
[`38_g3_production_promotion_cas.md`](docs/ui_integration/38_g3_production_promotion_cas.md)에 기록합니다.
...
현재 build의 실제 창에서 21-method preload, 11개 한글 메뉴, fixture 상태 복원,
...
- selected-range render/fresh probe 계약과 실제 output-quality 승인
